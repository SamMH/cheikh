...
<html lang="fr">
    <head>
        ...
        <link href="<?= WEBROOT ?>views/skin/css/bgSlide.css" rel="stylesheet">
        <link href="<?= WEBROOT ?>views/skin/css/whhg.css" rel="stylesheet">
        <link href="<?= WEBROOT ?>views/skin/css/carousel.css" rel="stylesheet">
    ...
    <body id="page">
        ...
        <div class="header header-home">
            <img src='<?= WEBROOT ?>views/skin/img/h13.png' width='100%'/>
            <a href="<?= WEBROOT ?>"></a>
        </div>

        <div class="navbar navbar-home navbar-default" role="navigation">
